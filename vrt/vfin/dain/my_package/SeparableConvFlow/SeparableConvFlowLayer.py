...
class SeparableConvFlowLayer(Function):
    ...
    def backward(self, gradoutput):
        ...
        gradinput1 = torch.zeros(
            self.input1.size())  # the input1 has zero gradient because flow backprop. nothing to gradinput1
        ...
        if self.input1.is_cuda:
            ...
            err = my_lib.SeparableConvFlowLayer_gpu_backward(self.input1, self.input2, self.input3, gradoutput,
            ...
            err = my_lib.SeparableConvFlowLayer_cpu_backward(self.input1, self.input2, self.input3, gradoutput,
                                                             gradinput1, gradinput2, gradinput3)
